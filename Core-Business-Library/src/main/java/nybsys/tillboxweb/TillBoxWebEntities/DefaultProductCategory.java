...
@Entity
public class DefaultProductCategory extends BaseEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DefaultProductCategory)) return false;
        if (!super.equals(o)) return false;
        DefaultProductCategory that = (DefaultProductCategory) o;
