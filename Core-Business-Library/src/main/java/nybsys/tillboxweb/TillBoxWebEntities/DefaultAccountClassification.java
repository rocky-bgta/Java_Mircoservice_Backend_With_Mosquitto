...
@Entity
public class DefaultAccountClassification extends BaseEntity{
    @Id
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DefaultAccountClassification)) return false;
        if (!super.equals(o)) return false;
        DefaultAccountClassification that = (DefaultAccountClassification) o;
