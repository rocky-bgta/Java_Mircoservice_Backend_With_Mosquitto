...
@Entity
public class DefaultSupplierCategory extends BaseEntity {
    @Id
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DefaultSupplierCategory)) return false;
        if (!super.equals(o)) return false;
        DefaultSupplierCategory that = (DefaultSupplierCategory) o;
