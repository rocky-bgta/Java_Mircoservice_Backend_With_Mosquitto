...
@Entity
public class DefaultCurrencyExchangeRate extends BaseEntity {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DefaultCurrencyExchangeRate)) return false;
        if (!super.equals(o)) return false;
        DefaultCurrencyExchangeRate that = (DefaultCurrencyExchangeRate) o;
