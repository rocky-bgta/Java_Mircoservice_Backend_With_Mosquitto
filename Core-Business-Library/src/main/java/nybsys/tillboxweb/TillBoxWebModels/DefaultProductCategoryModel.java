...
public class DefaultProductCategoryModel extends BaseModel {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DefaultProductCategoryModel)) return false;
        if (!super.equals(o)) return false;
        DefaultProductCategoryModel that = (DefaultProductCategoryModel) o;
