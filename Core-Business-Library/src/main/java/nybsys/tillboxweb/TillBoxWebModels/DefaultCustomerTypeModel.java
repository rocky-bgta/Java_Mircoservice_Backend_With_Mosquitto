...
public class DefaultCustomerTypeModel extends BaseModel{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DefaultCustomerTypeModel)) return false;
        if (!super.equals(o)) return false;
        DefaultCustomerTypeModel that = (DefaultCustomerTypeModel) o;
