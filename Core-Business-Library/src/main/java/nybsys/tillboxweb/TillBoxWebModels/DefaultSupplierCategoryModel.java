...
public class DefaultSupplierCategoryModel extends BaseModel{
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DefaultSupplierCategoryModel)) return false;
        if (!super.equals(o)) return false;
        DefaultSupplierCategoryModel that = (DefaultSupplierCategoryModel) o;
