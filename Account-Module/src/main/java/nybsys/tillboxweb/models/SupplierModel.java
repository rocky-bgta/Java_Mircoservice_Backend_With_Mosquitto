...
public class SupplierModel extends BaseModel {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), getSupplierID(), getBusinessID(), getSupplierCategoryID(), getSupplierName(), getAddress(), getPhone(), getEmail(), getOpeningBalanceAmount(), getOpeningBalanceDate(), getAutoAllocatePayment(), getPreferredCurrencyID());
    }
