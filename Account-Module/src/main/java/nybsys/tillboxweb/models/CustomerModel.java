...
public class CustomerModel extends BaseModel {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), getCustomerID(), getBusinessID(), getCustomerCategoryID(), getCustomerName(), getAddress(), getPhone(), getEmail(), getOpeningBalanceAmount(), getOpeningBalanceDate(), getPreferredCurrencyID(), getAutoAllocateReceipt(), getAcceptElectronicInvoice(), getViewInvoiceOnline());
    }
