...
public class CustomerContactTypeServiceManager extends BaseService {
    private static final Logger log = LoggerFactory.getLogger(CustomerContactTypeServiceManager.class);
    ...
    public ResponseMessage saveContactType(RequestMessage requestMessage) {
        ...
        try {
            ...
            contactTypeModel.setReferenceType(PartyType.Customer.get());
            ...
            log.error("CustomerContactTypeServiceManager -> saveContactType got exception");
    ...
    public ResponseMessage searchContactType(RequestMessage requestMessage) {
        ...
        try {
            ...
            log.error("CustomerContactTypeServiceManager -> searchContactType got exception");
            responseMessage = this.getDefaultResponseMessage(requestMessage.requestObj, TillBoxAppConstant.INTERNAL_SERVER_ERROR, TillBoxAppConstant.INTERNAL_SERVER_ERROR_CODE);
            this.WriteExceptionLog(ex);
        }
    ...
    public ResponseMessage getContactTypeByID(RequestMessage requestMessage) {
        ...
        try {
            ...
            log.error("CustomerContactTypeServiceManager -> getContactTypeByID got exception");
            responseMessage = this.getDefaultResponseMessage(requestMessage.requestObj, TillBoxAppConstant.INTERNAL_SERVER_ERROR, TillBoxAppConstant.INTERNAL_SERVER_ERROR_CODE);
            this.WriteExceptionLog(ex);
        }
