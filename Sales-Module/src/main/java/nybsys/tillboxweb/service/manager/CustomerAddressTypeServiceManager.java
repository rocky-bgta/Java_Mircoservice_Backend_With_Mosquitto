...
public class CustomerAddressTypeServiceManager extends BaseService {
    private static final Logger log = LoggerFactory.getLogger(CustomerAddressTypeServiceManager.class);
    ...
    public ResponseMessage saveAddressType(RequestMessage requestMessage) {
        ...
        try {
            ...
            addressTypeModel.setReferenceType(PartyType.Customer.get());
            ...
            log.error("CustomerAddressTypeServiceManager -> saveAddressType got exception");
    ...
    public ResponseMessage searchAddressType(RequestMessage requestMessage) {
        ...
        try {
            ...
            log.error("CustomerAddressTypeServiceManager -> searchAddressType got exception");
            responseMessage = this.getDefaultResponseMessage(requestMessage.requestObj, TillBoxAppConstant.INTERNAL_SERVER_ERROR, TillBoxAppConstant.INTERNAL_SERVER_ERROR_CODE);
            this.WriteExceptionLog(ex);
        }
    ...
    public ResponseMessage getAddressTypeByID(RequestMessage requestMessage) {
        ...
        try {
            ...
            log.error("CustomerAddressTypeServiceManager -> getAddressTypeByID got exception");
            responseMessage = this.getDefaultResponseMessage(requestMessage.requestObj, TillBoxAppConstant.INTERNAL_SERVER_ERROR, TillBoxAppConstant.INTERNAL_SERVER_ERROR_CODE);
            this.WriteExceptionLog(ex);
        }
    ...
    private ResponseMessage interModuleCommunication(AddressTypeModel addressTypeModel,String serviceLink) {
        ...
        try {
            ...
            ex.printStackTrace();
            log.error("CustomerAddressTypeServiceManager -> interModuleCommunication got exception");
        }
        return responseMessage;
    }
}
